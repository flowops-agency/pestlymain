    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-[200] border-t border-gray-200 bg-white/95 px-4 py-4 shadow-lg backdrop-blur-md md:bottom-4 md:left-auto md:right-4 md:w-[400px] md:rounded-2xl md:border"
        >
