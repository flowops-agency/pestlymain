          ...
          >
            ...
            >
              <div className="space-y-8 rounded-[28px] bg-[#F5F5F5] px-4 pb-8 pt-4 shadow-[0px_95px_27px_0px_rgba(0,0,0,0.00),0px_61px_24px_0px_rgba(0,0,0,0.03),0px_34px_21px_0px_rgba(0,0,0,0.11),0px_15px_15px_0px_rgba(0,0,0,0.19),0px_4px_8px_0px_rgba(0,0,0,0.22)]">
                ...
                <LocalizedLink
                  href="#demo"
                  className="inline-flex items-center justify-center rounded-[6px] bg-[linear-gradient(181deg,#5E5E5E_18.12%,#000_99.57%)] px-6 py-3 text-sm font-bold text-white shadow-[0px_4px_8px_0px_rgba(3,7,18,0.06),0px_2px_4px_0px_rgba(3,7,18,0.06),0px_0px_0px_1px_rgba(3,7,18,0.08),0px_1px_1px_2px_rgba(255,255,255,0.40)_inset,0px_-1px_5px_2px_rgba(255,255,255,0.40)_inset] transition duration-200 hover:-translate-y-0.5"
                >
                  {t.cta}
                </LocalizedLink>
